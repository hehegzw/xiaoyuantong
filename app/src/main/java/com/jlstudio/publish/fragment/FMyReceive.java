 ...
 */
public class FMyReceive extends Fragment implements  PublishDatasAdapter.OnRecyclerViewListener {
...
//                getDatasFromNet();
//            } else {
//                list = JsonToPubhlishData.getePublishListData(data.getContent(),"receive");
...
//                    }
                    list = JsonToPubhlishData.getePublishListData(s, "receive");
                    adapter.setList(list);
                    adapter2.notifyDataSetChanged();
                } else {
